...
public interface PersonRepository extends CrudRepository<Person, String> {
     ...
     * @return A {@link List} of {@link Person}s with the first name given in the parameter.
     *              Can be empty.
     */
     ...
     * @return A {@link List} of {@link Person}s with the last name given in the parameter.
     *              Can be empty.
     */
     ...
     * @param firstName {@link String} The first name of a person.
     * @param lastName {@link String} The last name of a person.
     * @return A {@link List} of {@link Person}s with the first and last name,
     *              given in the parameter. Can be empty.
     */
